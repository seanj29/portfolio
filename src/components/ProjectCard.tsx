      ...
      <li className="flex flex-col mb-10 mr-4 lg:ml-2 lg:flex-row">
        ...
        <div className="flex flex-col items-start justify-center">
          ...
          <div className="flex flex-row">
            {githubURL && <a href={githubURL} className=" mt-4 text-white hover:text-black hover:border-black dark:text-black dark:hover:text-white dark:hover:border-white">
            ...
            {itchURl && <a href={itchURl} className="text-white hover:text-black hover:border-black dark:text-black dark:hover:text-white dark:hover:border-white">
