...
//TODO: add props to this component
  ...
  const hasItch = true;
    ...
    return (
      <div className="flex flex-col mr-4 lg:ml-2 lg:flex-row">
        <div className="h-auto mb-2 w-fi lg:mr-4">
        ...
        <div className="flex flex-col items-start justify-center">
          ...
          <div className="flex">
            {hasGithub && <button>
                            <svg className="h-8 w-8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><title>Github</title>
            ...
            {hasItch && <button>
                            <svg className="h-16 w-16"  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024"><title>Itch</title>
