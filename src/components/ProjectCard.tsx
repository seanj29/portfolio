...
//TODO: add props to this component
  ...
  const hasItch = true;
    ...
    return (
      ...
      {text.Projects[0].desc}
          </p>
          <div className="flex">
            {hasGithub && <button className="text-black hover:text-white hover:border-white">
            ...
            {hasItch && <button className="text-black hover:text-white hover:border-white">
                            <svg className="fill-current h-16 w-16"  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024"><title>Itch</title>
