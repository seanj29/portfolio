    ...
    return (
      ...
      {text.Projects[0].desc}
          ...
          <div className="flex flex-row">
            {hasGithub && <a href={text.Projects[0].githubURL} className=" mt-4 text-black hover:text-white hover:border-white">
            ...
            {hasItch && <a href={text.Projects[0].itchURl} className="text-black hover:text-white hover:border-white">
