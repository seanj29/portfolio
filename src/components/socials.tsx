...
const Footer = () =>{
    ...
    <ul className="flex items-center">
        <li className="mr-2 text-xs">
            ...
            <a href="https://github.com/seanj29" className="text-black hover:text-white hover:border-white">
        ...
        <li className="mr-2 text-xs">
            ...
            <a href="https://seanj29.itch.io/" className="text-black hover:text-white hover:border-white">
        ...
        <li className="mr-2 text-xs">
            ...
            <a href="https://www.linkedin.com/in/sean-otto-48936926a/" className="text-black hover:text-white hover:border-white">
