          ...
          <form className="space-y-8" method= "post" action= "https://getform.io/f/f84ff6b3-7ec3-448e-a19c-b83959e6e69c" autoComplete="on">
              ...
              <div className="space-y-8 lg:inline-flex lg:space-x-24 lg:space-y-0">
                <div>
                  ...
                  <input type="email" id="email" name={emailValue} value={emailValue} onChange={e => setEmailValue(e.target.value)} className="shadow-sm bg-gray-50 border border-gray-300 text-black text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light " placeholder="name@email.com" required/>
                </div>
                <div>
                  <label htmlFor="number" className="block mb-2 text-sm font-medium text-black dark:text-gray-300">Phone Number</label>
                  <input type="tel" id="number" name={numberValue}  value={numberValue} onChange={e => setNumberValue(e.target.value)} pattern="^[\+]?[(]?[0-9]{3}[)]?[-\s\.]?[0-9]{3}[-\s\.]?[0-9]{4,6}$" className="shadow-sm bg-gray-50 border border-gray-300 text-black text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light " placeholder="07391591132"/>
                </div>
              </div>
              <div className="sm:col-span-2">
                ...
                <textarea id="message" name={messageValue} value={messageValue} onChange={e => setMessageValue(e.target.value)} rows={6} className="block p-2.5 w-full text-sm text-black bg-gray-50 rounded-lg shadow-sm border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 " placeholder="Leave a comment..." required></textarea>
              </div>
