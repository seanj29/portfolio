...
const ExperiencePage = () => {
    return(    
        <div className="relative w-full h-full mx-auto px-6 py-12 lg:w-screen lg:h-screen">
            <Navbar/>
            <div className="flex-col mt-20 ml-6 lg:ml-15 max-w-screen-2xl">
                ...
                <a href="../../resume.pdf" className="lg:ml-96 font-semibold text-lg text-white hover:text-black dark:text-black  dark:hover:text-white hover:underline">
                            View Full Résumé
